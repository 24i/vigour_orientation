...
describe('Testing data flows between native and js using the bridge', () => {
  ...
  describe('Testing data flows for bridge', () => {
    // basic init expects to receive a ready call with the current orientation, eg: 'portrait'
    it('after init should call ready with either landscape or portrait as argument', (done) => {
    ...
    it('when calling set it will call 2 times receive, one with the orientation setted and then with a lock', (done) => {
    ...
    it('when calling lock it will call receive with type lock and data true', (done) => {
      var spy = sinon.spy(bridge, 'receive')
    ...
    it('when calling lock it will call receive with type lock and data false', (done) => {
      var spy = sinon.spy(bridge, 'receive')
